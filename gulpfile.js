...
const PROJECT_SASS_SRC = "./resources/sass";

// Images destination
const IMG_DEST = "./resources/assets/images";

// Fonts destination
const FONTS_DEST = "./resources/assets/fonts";

// Javascript destination
const JS_DEST = "./resources/js";

// Compiled CSS destination
const CSS_DEST = "./resources/css";

// Site CSS destination
// Like the _site/assets/css directory in Jekyll, if necessary.
// If using, uncomment line 106
const SITE_CSS_DEST = "./resources/css";
